...
$(".find_nav_list li").each(function(){
    $(".sideline").css({left:0});
    //$(".find_nav_list li").eq(0).addClass("active").siblings().removeClass("active");
});
...
$(".find_nav_list li").on('click', function(){
    ...
    var fn_w = ($(".find_nav").width() - nav_w) / 1.3;
    var fnl_l;
...
for(n=1;n<4;n++){
    ...
    var tt=new TouchSlider({id:mslide,'auto':'-1',fx:'ease-out',direction:'left',speed:600,timeout:5000,'before':function(index){
            ...
            $(".find_nav_list li").eq(this.p).addClass("active").siblings().removeClass("active");
